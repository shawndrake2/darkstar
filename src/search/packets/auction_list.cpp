...
/************************************************************************
*                                                                       *
*  If the number of items sent exceeds 20, then we send them in several *
*  packages, in each of their short we record the offset                *
*                                                                       *
************************************************************************/
...
/************************************************************************
*                                                                       *
*  Add the item to the package (10 bytes per day)                       *
*                                                                       *
************************************************************************/
