...
MAX_LEVEL = 119; -- Level max of the server, lowers the attainable cap by disabling Limit Break quests.
NORMAL_MOB_MAX_LEVEL_RANGE_MIN = 101; -- Lower Bound of Max Level Range for Normal Mobs (0 = Uncapped)
NORMAL_MOB_MAX_LEVEL_RANGE_MAX = 104; -- Upper Bound of Max Level Range for Normal Mobs (0 = Uncapped)
...
CURE_POWER      = 10.000; -- Multiplies amount healed from Healing Magic, including the relevant Blue Magic.
ELEMENTAL_POWER = 10.000; -- Multiplies damage dealt by Elemental and non-drain Dark Magic.
DIVINE_POWER    = 10.000; -- Multiplies damage dealt by Divine Magic.
NINJUTSU_POWER  = 10.000; -- Multiplies damage dealt by Ninjutsu Magic.
BLUE_POWER      = 10.000; -- Multiplies damage dealt by Blue Magic.
DARK_POWER      = 10.000; -- Multiplies amount drained by Dark Magic.
...
HARVESTING_BREAK_CHANCE = 0.03; -- % chance for the sickle to break during harvesting.  Set between 0 and 1.
EXCAVATION_BREAK_CHANCE = 0.03; -- % chance for the pickaxe to break during excavation.  Set between 0 and 1.
LOGGING_BREAK_CHANCE    = 0.03; -- % chance for the hatchet to break during logging.  Set between 0 and 1.
MINING_BREAK_CHANCE     = 0.03; -- % chance for the pickaxe to break during mining.  Set between 0 and 1.
HARVESTING_RATE         = 0.95; -- % chance to recieve an item from haresting.  Set between 0 and 1.
EXCAVATION_RATE         = 0.95; -- % chance to recieve an item from excavation.  Set between 0 and 1.
LOGGING_RATE            = 0.95; -- % chance to recieve an item from logging.  Set between 0 and 1.
MINING_RATE             = 99; -- % chance to recieve an item from mining.  Set between 0 and 100.
